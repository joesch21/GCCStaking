...
export const Staking = () => {
  ...
  return (
    ...
    >
      ...
      <hr
        style={{ width: "100%", border: "1px solid #333", margin: "20px 0" }}
      />
      <div style={{ margin: "20px 0", width: "100%" }}>
        <h2>Owned NFTs</h2>
        <p style={{ color: "#ffcc00", fontSize: "10px" }}>
          Approve each NFT before staking. Once approved, the button will display
          staking - press the button again to Stake.
        </p>
        <div
          style={{
            display: "flex",
